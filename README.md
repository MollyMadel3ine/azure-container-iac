...
**Status: Phase 1 complete** — local container loop complete; Phase 2 CI/CD next.
...
- [X] **Phase 1 — Containerize + core infrastructure**: multi-stage Dockerfile (non-root, ~150MB), Azure Container Registry, Container Apps environment + app via Terraform, remote state
